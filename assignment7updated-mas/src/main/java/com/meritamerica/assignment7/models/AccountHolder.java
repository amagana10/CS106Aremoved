...
public class AccountHolder implements Comparable<AccountHolder> {
	...
	@ManyToOne
	public IRARegular iraRegular;
	
	@ManyToOne
	public IRARollover iraRollover;
	
	@ManyToOne
	public IRARoth iraRoth;
...
// Goes through the account holder's savings accounts and returns the sum of them.
	...
	public IRARegular getIraRegular() {
		return iraRegular;
	}

	public void setIraRegular(IRARegular iraRegular) {
		this.iraRegular = iraRegular;
	}

	public IRARollover getIraRollover() {
		return iraRollover;
	}

	public void setIraRollover(IRARollover iraRollover) {
		this.iraRollover = iraRollover;
	}

	public IRARoth getIraRoth() {
		return iraRoth;
	}

	public void setIraRoth(IRARoth iraRoth) {
		this.iraRoth = iraRoth;
	}
