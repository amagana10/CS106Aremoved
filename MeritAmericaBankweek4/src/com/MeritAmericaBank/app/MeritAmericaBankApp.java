...
public class MeritAmericaBankApp {
	public static void main(String[] args) {
		...
		ah1.CheckingAccount(checkingAccountOne);
		...
		ah1.CheckingAccount(50000.0);
		ah1.addSavingsAccount(500000.00);
		ah1.CheckingAccount(5000.0);
		...
		AccountHolder ah2 = new AccountHolder("Lorelai", "V.", "Gilmore", "876543210", 0.0, 0.0);
		
		ah2.CheckingAccount(1000.0);
		...
		AccountHolder ah3 = new AccountHolder("Rory", "V.", "Gilmore", "081726354", 0, 0);
		
		ah3.addCDAccount(MeritBank.getBestCDOffering(3000), 3000);
		System.out.println("CD Account Balance: " + ah3.getCombinedBalance());
		
		ah3.CheckingAccount(1000);
